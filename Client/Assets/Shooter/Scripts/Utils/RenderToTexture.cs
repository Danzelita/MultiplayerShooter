...
namespace Shooter.Scripts.Utils
{
    public class RenderToTexture : MonoBehaviour
    {
        //ТУТ ТОЧНО НИЧЕГО ИНТЕРЕСНОГО. Скрипт чат гпт писал
        ...
        private string _savePath = "C:/UnityProjects/MultiplayerShooter/Client/Assets/Shooter/Art/Guns/Icons/";
